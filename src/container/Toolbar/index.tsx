...
export default function Toolbar(props: Props) {
  ...
  const debugPos = useBearStore((state) => state.debugPos)
  const lang = useBearStore((state) => state.lang)
  const setLang = useBearStore((state) => state.setLang)
  const game = useBearStore((state) => ({
